...
''';
  ...
  void _sendWelcomeEmail({required String name, required String email}) async {
    await sendCustomEmail(
      recipientEmail: email,
      subject: "Welcome to Tampo!",
      body: """
      <h2>Hi $name,</h2>
      <p>Welcome to Tampo! 🎉</p>
      <p>Start here: <a href="www.tampoapp.com">www.tampoapp.com</a></p>
    """,
    );
  }
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
            color: Colors.grey.withOpacity(0.1), // 👈 grey alpha 0.1
          ),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(10),
          borderSide: BorderSide(
            color: Colors.grey.withOpacity(0.1), // 👈 same for focused
            width: 1.5,
          ),
        ),
      ),
