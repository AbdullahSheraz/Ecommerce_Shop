    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (currentIndex == 0 ||
              currentIndex == 1 ||
              currentIndex == 3) // Discover/Explore page
            Padding(
          ...
          if (currentIndex == 0 || currentIndex == 1 || currentIndex == 2)
            Container(
              ...
              padding: const EdgeInsets.all(8),
              decoration: BoxDecoration(
                  shape: BoxShape.circle, color: Colors.grey.withOpacity(0.08)),
              child: Stack(
                clipBehavior: Clip.none,
                children: [
                  Icon(
      ...
      bottomNavigationBar: Row(
        children: [
          ...
          _buildNavItem(
            ...
            filledIcon: LucideIcons.search, // example filled variant
            label: "Explore",
          ...
          _buildNavItem(
            ...
            filledIcon: Icons.shopping_cart, // same if no filled variant
            label: "Cart",
          ...
          _buildNavItem(
            ...
            filledIcon: Icons.person, // example filled variant
            label: "Profile",
